...
namespace TerminalWars {
	...
	int CreateMenu(int yPos, int xPos, int height, int width, vector<string> menuItems, bool cancelable = true, int defaultSelect = 0, int unselectBack = BLACK, int unselectFore = GREY, int selectBack = BLACK, int selectFore = YELLOW, int disabledBack = BLACK, int disabledFore = DARKGREY, int disabledSelectBack = BLACK, int disabledSelectFore = BROWN);
